...
const sample_indicator_1 = require("./indicators/sample.indicator");
let HealthCheckController = class HealthCheckController {
    constructor(health, http, db, sampleHealthIndicator) {
        this.health = health;
        this.http = http;
        this.db = db;
        this.sampleHealthIndicator = sampleHealthIndicator;
    }
    check() {
...
HealthCheckController = __decorate([
    ...
    __metadata("design:paramtypes", [terminus_1.HealthCheckService,
        ...
        sample_indicator_1.SampleHealthIndicator])
